...
(___________)(______) 
\n\n╔════════════════════════════════╗
\n\n║ YOUTUBER  : ________H__A__K___E___E___M__                                 ║
\n\n║ GITHUB       :     https://ABDUL HAKEEM          ║
\n\n║ FACEBOOK  : https://www.facebook.com/meer.raaj.503/║
\n\n╚════════════════════════════════╝" | lolcat -a -d 2 -s 50')
	print("")
...
def azimvau():
    ...
    if nunu in ('open', 'Open', 'OPEN'):
        raw_input('\n %s*%s PRESS ENTER ' % (O, N))
        os.system('xdg-open https://yutube.com/channel/UCWt-u2A')
        azimvau()
    try:
...
def mr_error():
    ...
    os.system('echo "
\n [1]. MAKE FILE ID FROM FRIENDS
\n [2]. MAKE FILE FROM PUBLIC ID FRIEND
